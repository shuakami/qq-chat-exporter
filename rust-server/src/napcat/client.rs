//! NapCat Core API bridge 客户端。
//!
//! Rust 服务端不直接嵌入 QQ 运行时，而是通过 NapCat 侧的极薄 TS bridge 插件
//! （localhost JSON-RPC）调用 NapCat Core API（MsgApi / GroupApi / FriendApi /
//! FileApi / WebApi / UserApi / PacketApi）。
//!
