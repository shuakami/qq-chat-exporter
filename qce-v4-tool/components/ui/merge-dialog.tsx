      ...
      <DialogContent className="max-w-2xl">
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-muted-foreground">至少选择2个已完成的导出任务进行合并</p>
            
            {tasks.length === 0 ? (
              <div className="rounded-lg border border-dashed border-black/[0.08] dark:border-white/[0.08] bg-muted/50 p-8 text-center">
                <AlertCircle className="w-8 h-8 mx-auto mb-2 text-muted-foreground/60" />
                <p className="text-sm text-muted-foreground">暂无可合并的任务</p>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  className="bg-card"
                />
                <p className="text-xs text-muted-foreground">留空将使用默认输出目录</p>
              </div>
            </div>
          </div>
          ...
          {merging && mergeProgress && (
            <div className="space-y-3 rounded-lg border border-black/[0.06] dark:border-white/[0.06] bg-muted/50 p-4">
              ...
              <p className="text-xs text-muted-foreground">{mergeProgress.message}</p>
            </div>
          )}
        </div>

        <div className="flex justify-end gap-3 px-6 py-4 border-t border-black/[0.06] dark:border-white/[0.06]">
          <Button 
            variant="outline" 
