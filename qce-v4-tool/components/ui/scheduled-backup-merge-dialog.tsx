        ...
        <div className="flex-1 flex gap-8 min-h-0 px-6 py-6">
          ...
          <div className="w-2/5 flex flex-col">
            <div className="mb-4">
              ...
              <p className="text-sm text-neutral-600">至少选择 2 个备份文件进行合并</p>
            </div>
            
            <div className="flex-1 overflow-hidden">
              {scheduledTasks.length === 0 ? (
                <div className="h-full flex items-center justify-center rounded-2xl border border-dashed border-neutral-300 bg-neutral-50">
                  <div className="text-center p-8">
                    <AlertCircle className="w-12 h-12 mx-auto mb-3 text-neutral-400" />
                    <p className="text-base font-medium text-neutral-700">暂无定时备份</p>
                    <p className="text-sm text-neutral-500 mt-1">请先创建并运行定时导出任务</p>
                  </div>
                </div>
              ) : (
                <ScrollArea className="h-full rounded-2xl border border-neutral-200 p-2 bg-white/70">
                  <div className="space-y-1">
                    {scheduledTasks.map(task => (
                      <div key={task.taskName} className="rounded-xl bg-white overflow-hidden">
                        {/* 任务头部 */}
                        <div className="flex items-center gap-3 p-3 hover:bg-neutral-50 transition-colors">
                          <Checkbox
                        ...
                        {expandedTasks.has(task.taskName) && (
                          <div className="border-t border-neutral-100 bg-neutral-50/50">
                            {task.backups.map(backup => (
                              <div
                                key={backup.fileName}
                                className="flex items-center gap-3 p-3 pl-11 hover:bg-white transition-colors"
                              >
                                <Checkbox
          ...
          <div className="w-3/5 flex flex-col">
            <div className="mb-4">
              ...
              <p className="text-sm text-neutral-600">设置如何处理合并后的文件</p>
            </div>
              ...
              <div className="space-y-3">
                ...
                <div
                  className={[
                    ...
                    deduplicateMessages ? "border-neutral-300 bg-neutral-50/50" : "border-neutral-200 hover:border-neutral-300",
