                ...
                <div className="space-y-6">
                  {(() => {
                    const options = [
                      ...
                      { id: "embedAvatarsAsBase64", checked: draft.embedAvatarsAsBase64, set: (v: boolean) => patch({ embedAvatarsAsBase64: v }), title: "嵌入头像为 Base64", desc: draft.streamingZipMode ? "将发送者头像写入导出目录的 avatars.json" : "将发送者头像嵌入 JSON 文件", visible: draft.format === "JSON", group: "导出内容" },
